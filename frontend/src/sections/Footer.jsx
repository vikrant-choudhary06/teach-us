...
const BookIcon = () => (
  <svg
    className="w-5 h-5 text-[#82e23e] shrink-0 select-none pointer-events-none"
    fill="none"
    stroke="currentColor"
    strokeWidth="2"
    viewBox="0 0 24 24"
...
const PhoneIcon = () => (
  <svg className="w-4 h-4 text-[#82e23e] shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
