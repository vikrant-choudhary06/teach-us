...
const SparklesIcon = () => (
  ...
  >
    {/* Big sparkle */}
    <path d="M12 2a0.75 0 0 0-0.75 0.75v1.5c0 3.3-2.7 6-6 6H3.75a0.75 0 0 0 0 1.5H5.25c3.3 0 6 2.7 6 6v1.5a0.75 0 0 0 1.5 0v-1.5c0-3.3 2.7-6 6-6h1.5c0.41 0 0.75-0.34 0.75-0.75s-0.34-0.75-0.75-0.75H18.75c-3.3 0-6-2.7-6-6V2.75A0.75 0 0 0 12 2Z" />
    {/* Small sparkle */}
    <path
      d="M19 12a0.5 0 0 0-0.5 0.5v0.75c0 1.6-1.3 3-3 3h-0.75a0.5 0 0 0 0 1h0.75c1.6 0 3 1.3 3 3v0.75a0.5 0 0 0 1 0v-0.75c0-1.6 1.3-3 3-3h0.75a0.5 0 0 0 0-1h-0.75c-1.6 0-3-1.3-3-3v-0.75A0.5 0 0 0 19 12Z"
      opacity="0.8"
    />
  </svg>
);
      ...
      <div className="container-custom relative z-10 px-4">
        ...
        <div className="flex items-center justify-center gap-3.5 mb-16">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="bg-[#10b981]/15 text-[#10b981] border border-[#10b981]/25 text-[10px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wider">
              20% OFF
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto items-stretch">
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                background: `radial-gradient(400px circle at ${coords.x}px ${coords.y}px, rgba(16, 185, 129, 0.05), transparent 80%)`,
              }}
            />
          ...
          <div
            ...
            onMouseLeave={() => setHoveredCardIndex(null)}
            className="relative rounded-[2rem] border border-emerald-500/50 bg-[#0d1015]/95 p-8 flex flex-col h-full transition-all duration-300 overflow-hidden shadow-[0_0_40px_rgba(16,185,129,0.06)]"
          >
            {/* Top green line glow highlight */}
            <div className="absolute top-0 left-0 right-0 h-[2.5px] bg-gradient-to-r from-transparent via-[#88e225] to-transparent shadow-[0_0_15px_#88e225]" />
            ...
            <div
              ...
              style={{
                ...
                background: `radial-gradient(400px circle at ${coords.x}px ${coords.y}px, rgba(136, 226, 37, 0.07), transparent 80%)`,
              }}
            />
            ...
            <div className="mb-8 relative z-10">
              <Link
                to="/login"
                className="w-full inline-flex items-center justify-center py-3 px-6 rounded-full bg-[#82e23e] hover:bg-[#72cc2e] text-black font-bold text-xs sm:text-sm transition-all shadow-[0_4px_25px_rgba(130,226,62,0.18)]"
              >
                Get Pro Membership
              </Link>
            </div>
