...
export default function FeaturesSection() {
  ...
  const [plannerTopic, setPlannerTopic] = useState("saas");
  const plannerData = {
    saas: {
      subject: "Advanced Masterclass",
      title: "SaaS Boilerplate Blueprint",
      objectives: [
        "Design microservices schema",
        "Deploy multi-tenant DB structure",
      ],
      activity: "Build & deploy a Next.js landing page with Stripe billing.",
    },
    figma: {
      subject: "Deep-Dive/Intermediate",
      title: "Advanced Figma Architecture",
      objectives: [
        "Master nested component states",
        "Configure layout grid transitions",
      ],
      activity: "Design an animated dashboard prototype with custom micro-interactions.",
    },
    marketing: {
      subject: "Fundamental/Beginner",
      title: "Growth Hacking Fundamentals",
      objectives: [
        "Set up Google Analytics event tags",
        "Run multi-variant A/B campaigns",
      ],
      activity: "Draft a conversion copywriting framework for a newsletter signup flow.",
    },
  };
  ...
  const stories = [
    {
      ...
      story:
        "Once upon a time in a school in Pune, a teacher explained gravity by telling a story about planets playing tag around the campfire (the Sun), running in circular tracks...",
    },
    {
      topic: "Class 9 • Water Cycle",
      story:
        "Meet Pip, a water drop. After sunbathing on a leaf, he floated up to join a cloud party, got heavy, and parachuted down as rain to start the slide again...",
    },
  ];
  ...
  return (
    <section
      id="features"
      className="section-padding bg-brand-forest relative overflow-hidden"
    >
      ...
      <div className="container-custom relative z-10 max-w-6xl">
        ...
        <div className="mb-16 text-center flex flex-col items-center">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 font-space max-w-3xl leading-tight">
            ...
            <span className="text-emerald-300">Transform your Courses.</span>
          </h2>
          <p className="text-sm text-brand-sage/80 max-w-xl font-sans">
            Explore clean, automated assistant tools designed specifically for
            modern course creators.
          </p>
        </div>

        {/* Bento Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-fr">
          {/* Card 1: AI Syllabus Architect (Double size width, single height - 2 Cols x 1 Row) */}
              ...
              <div className="flex flex-col justify-between flex-1 md:w-[55%]">
                <div>
                  ...
                  <h3 className="text-xl font-bold text-white font-space mt-2">
                    Architect Syllabuses in Seconds.
                  </h3>
                  <p className="text-white/75 text-[11px] mt-1 font-sans leading-normal">
                    Draft complete syllabus guides. Choose a course topic below
                    to watch the planner generate steps instantly:
                  </p>
                ...
                <div className="pt-3">
                  ...
                  >
                    Architect Custom Syllabuses <HiArrowRight />
                  </Link>
                </div>
              </div>
                  ...
                  >
                    <div className="flex items-center justify-between border-b border-white/[0.06] pb-1">
                      <span className="text-[9px] text-gray-500 font-bold uppercase tracking-wider">
                        {plannerData[plannerTopic].subject}
                      </span>
                    ...
                    <div className="space-y-1.5">
                      <h4 className="text-xs font-bold text-white leading-tight">
                        {plannerData[plannerTopic].title}
                      </h4>
                      ...
                      <div className="pt-0.5">
                        ...
                        <p className="text-[10px] text-gray-300 italic leading-snug">
                          "{plannerData[plannerTopic].activity}"
                        </p>
                      </div>
                    </div>
                  </motion.div>
          ...
          {/* Card 3: Math Helper (1 Col x 1 Row) - Commented out */}
          {false && (
            <BentoCard>
              <div className="flex flex-col justify-between h-full gap-4">
                <div>
                  ...
                  <div className="space-y-1.5 my-1">
                    {mathSolutions[mathTab].steps.map((step, idx) => (
                      <motion.div
                        ...
                        key={idx}
                        className={
                          idx === mathSolutions[mathTab].steps.length - 1
                            ? "text-[#82e23e] font-bold text-[10px] flex items-center gap-1"
                            : "text-white/95 text-[10px]"
                        }
                      >
                        {idx === mathSolutions[mathTab].steps.length - 1 && (
                          <span className="text-[#82e23e]">✔</span>
                        )}
                        {step}
                      </motion.div>
                    ))}
          ...
          {/* Card 4: Hyper-Local Content (1 Col x 1 Row) - Commented out */}
          {false && (
            <BentoCard>
              <div className="flex flex-col justify-between h-full gap-4">
                <div>
            ...
            <div className="flex flex-col justify-between h-full gap-4">
              <div>
                ...
                <p className="text-white/75 text-xs mt-1 font-sans">
                  Generate moral-based concept stories to keep younger classes
                  engaged:
                </p>
              </div>
          ...
          {/* Card 6: Knowledge Base Checklists (1 Col x 1 Row) - Commented out */}
          {false && (
            <BentoCard>
              <div className="flex flex-col justify-between h-full gap-4">
                <div>
                ...
                <div className="flex-1 rounded-xl border border-white/15 bg-white/[0.04] p-4 flex flex-col justify-between gap-2 font-sans text-xs">
                  <div className="space-y-2">
                    {[
                      ...
                      <div
                        key={i}
                        className="flex items-center justify-between border-b border-white/[0.04] pb-1.5"
                      >
